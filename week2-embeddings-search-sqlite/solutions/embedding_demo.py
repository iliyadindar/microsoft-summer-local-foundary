...
def main():
    ...
    # One API call can embed a whole list of texts at once.
    ...
    # Notice: the top match shares MEANING with your query even when it
    # shares no words. That is what makes embeddings better than keyword
    # search for the retrieval step of RAG.
